/*
 * @FilePath: \fcc_5g_test_system_only_spectrum\testProcess\testIndex\spectrum\OBW\index.js
 * @Author: xxx
 * @Date: 2023-05-08 15:48:20
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-16 17:41:13
 * @Descripttion: 基站测试函数
 */
const { delayTime, addLogFn } = require("../../../utils");
const { logError } = require('../../../utils/logLevel')
