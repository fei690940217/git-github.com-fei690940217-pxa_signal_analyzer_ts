 ...
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-16 17:47:57
 * @FilePath: \fcc_5g_test_system_only_spectrum\testProcess\utils\adbCommand.js
 * @Description: 
 * 
 * Copyright (c) 2023 by ${git_name_email}, All Rights Reserved. 
 */
const { exec } = require('child_process');
const { delayTime, addLogFn, childSendMainMessage } = require("./index");
const { logError, logInfo } = require('./logLevel')
...
const openAirplaneModeCommand = 'adb shell settings put global airplane_mode_on 1'
const openBroadcast = `adb shell am broadcast -a android.intent.action.AIRPLANE_MODE --ez state 1`;
const closeAirplaneModeCommand = 'adb shell settings put global airplane_mode_on 0'
