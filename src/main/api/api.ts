 ...
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-20 13:23:01
 * @FilePath: \pxa_signal_analyzer\src\main\api\api.ts
 * @Description: api列表
 */
import axiosInstance from './request';
//关闭Python-visa代理服务
export const exit_visa_proxy = () => {
 ...
 */
export const set_timeout = (params) => {
  let obj = {
    instr_name: params.instr_name,
 ...
 */
export const get_soft_version = (appname) => {
  let obj = {
    appname: appname,
  };
