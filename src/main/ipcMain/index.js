 ...
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-16 13:33:56
 * @FilePath: \fcc_5g_test_system_only_spectrum\main\ipcMain\index.js
...
//子进程启动函数
const { createTestProcessInstance, getTestProcessInstance } = require("./testProcess/TestProcessSingleton.js");
//runVisaProxy
...
module.exports = () => {
  ...
  ipcMain.on("showItemInFolder", (event, payload) => {
    ...
    const dirpath = path.join(appConfigFilePath, 'user', 'project', projectName, subProjectName)
