 ...
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-20 13:30:40
 * @FilePath: \pxa_signal_analyzer\src\main\utils\visaIsStarting.ts
 * @Description:
 *
...
import { get_instr_list } from '@src/main/api/api';
...
const getPid = () => {
  return new Promise(async (resolve, reject) => {
    try {
      let tasklistOutput = childProcess.execSync(command, {
        encoding: 'utf-8',
      });
