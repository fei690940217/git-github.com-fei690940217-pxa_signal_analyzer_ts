 ...
 * @LastEditors: feifei
 * @LastEditTime: 2024-12-31 11:56:39
 * @FilePath: \pxa_signal_analyzer\src\renderer1\store\asyncThunk\setCurrentRow.ts
 * @Description:
 *
...
import { RootState, AppDispatch } from '@src/renderer1/store';
